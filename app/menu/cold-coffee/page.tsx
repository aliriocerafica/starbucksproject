  ...
  return (
    <div className="bg-[#FFF8F3] min-h-screen">
      ...
      <div className="flex flex-col items-center px-4">
        <h1 className="text-4xl sm:text-5xl mt-24 font-bold text-[#00704A] text-center">COLD COFFEE</h1>
        <p className="text-gray-500 text-sm sm:text-base mt-4 text-center">
          Refreshing iced beverages made with love
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 mt-10 w-full max-w-5xl px-4">
          ...
          <div className="bg-white p-4 rounded-lg shadow-md">
            ...
            <h3 className="text-md font-bold text-black mb-2">Iced Caramel Macchiato</h3>
          ...
          <div className="bg-white p-4 rounded-lg shadow-md">
            ...
            <h3 className="text-md font-bold text-black mb-2">Cold Brew Coffee</h3>
            <p className="text-sm text-gray-500 mb-4">
