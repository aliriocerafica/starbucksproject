          ...
          <ul className="flex flex-wrap justify-center gap-4 sm:gap-6 md:gap-10 text-sm">
            {[
              ...
              <li key={href}>
                <Link
                  href={href}
                  className={`px-4 sm:px-6 py-2 sm:py-3 rounded-full transition duration-300 ease-in-out ${isActive(href) ? "bg-[#00704A] text-white" : "bg-white text-[#00704A] hover:bg-[#00704A] hover:text-white"}`}
                >
                  {label}
                </Link>
              </li>
